...
public class KaliMod implements ModInitializer {
    ...
    // Cobalt Pickaxe
    public static ToolItem COBALT_PICKAXE = new CustomPickaxeItem(CobaltToolMaterial.INSTANCE, -1, -2.8F, new Item.Settings());
	...
	public void onInitialize() {
        ...
        // Cobalt Pickaxe
        Registry.register(Registries.ITEM, new Identifier("kalimod", "cobalt_pickaxe"), COBALT_PICKAXE);
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.TOOLS).register(content -> {
        	content.addAfter(Items.IRON_HOE, COBALT_PICKAXE);
        });
	}
}